...
<div align="center">
  <img src="assets/header.svg" alt="Ruffianjiang" width="100%" />
</div>
...
<p align="center">
  <b>全栈工程师 · 技术管理者</b><br/>
  长期深耕 <b>工业智能运维</b>、<b>大数据与实时计算</b>，
  以及 <b>数据湖 × 世界模型</b> 的融合实践。
</p>
...
<p align="center">
  ...
  <img alt="OceanBase" src="https://img.shields.io/badge/OceanBase-00758F?style=flat"/>
  <img alt="Apache Doris" src="https://img.shields.io/badge/Apache%20Doris-F5A623?style=flat"/>
...
- 🛡️ **工业智能运维平台** —— 多源报警推理、Redis Stream 双队列、Doris 数据湖与世界模型对比
- 📊 **数据分析与增强** —— 效率 / 分布 / 置信度 × 保留率交叉分析
- 🕸️ **基于 AntV G6 的数据血缘关系图** —— 多源数据流可视化
- 🤖 在工程实践中引入大模型辅助研发与团队提效
...
<p align="center">
  <img alt="Followers" src="https://img.shields.io/github/followers/Ruffianjiang?style=social"/>
  <img alt="Stars" src="https://img.shields.io/github/stars/Ruffianjiang?style=social"/>
